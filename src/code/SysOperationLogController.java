...
public class SysOperationLogController {
    ...
    public String queryIndex(Map<String,Object> dataMap,HttpServletRequest req) {
        ...
        List<SysOperationLog> resultList = sysOperationLogService.queryMap(queryMap, start, pageSize);
        Integer count = sysOperationLogService.count(queryMap);
    ...
    public String editIndex(Map<String, Object> dataMap, HttpServletRequest req) {
        ...
        SysOperationLog obj = sysOperationLogService.getById(id);
        dataMap.put("obj", obj);
        return "";
    }
    ...
    public @ResponseBody Integer add(HttpServletRequest req,SysOperationLog sysOperationLog) {
        return sysOperationLogService.add(sysOperationLog);
    }
    ...
    public @ResponseBody Integer edit(HttpServletRequest req,SysOperationLog sysOperationLog) {
        return sysOperationLogService.edit(sysOperationLog);
    }
}