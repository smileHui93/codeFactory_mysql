...
public class TabOrderController {
    ...
    public String queryIndex(Map<String,Object> dataMap,HttpServletRequest req) {
        ...
        List<TabOrder> resultList = tabOrderService.queryMap(queryMap, start, pageSize);
        Integer count = tabOrderService.count(queryMap);
    ...
    public String editIndex(Map<String, Object> dataMap, HttpServletRequest req) {
        ...
        TabOrder obj = tabOrderService.getById(id);
        dataMap.put("obj", obj);
        return "";
    }
    ...
    public @ResponseBody Integer add(HttpServletRequest req,TabOrder tabOrder) {
        return tabOrderService.add(tabOrder);
    }
    ...
    public @ResponseBody Integer edit(HttpServletRequest req,TabOrder tabOrder) {
        return tabOrderService.edit(tabOrder);
    }
}